...
//     // Check if data.user exists before storing
//     if (data.user) {
//       // Store the user in localStorage
//       localStorage.setItem("user", JSON.stringify(data.user));
//       console.log("User registered and saved to localStorage:", data.user);
...
//           headers: {
//             "Content-Type": "application/json",
//             "Authorization": `${user.accessToken}`, // Send the access token directly
//           },
//         });
...
//           const profileData = await response.json();
//           console.log("Fetched Profile Data:", profileData);
//           set({ user: { ...user, ...profileData }, isLoggedIn: true });
...
//         }
//       } else {
//         console.error("User data is invalid or missing access token");
//         localStorage.removeItem("user");
//         set({ user: null, isLoggedIn: false });
//       }
//     } catch (err) {
