...
const overpassPlaygroundSchema = new mongoose.Schema(
  {
    ...
    tags: {
      type: mongoose.Schema.Types.Mixed, // Flexible field for storing tag data like `access`, `leisure`, etc.
      required: true,
    },
...
overpassPlaygroundSchema.index({ location: "2dsphere" });

export const OverpassPlayground = mongoose.model(
  "OverpassPlayground",
  overpassPlaygroundSchema
);
